...
proc start { workDir { perturbForce 0 } { perturbSegmentation 0 } } {
  ...
  if {$perturbSegmentation} {  
    set preOpSegErrorX [randNormal 0 1]
    set preOpSegErrorY [randNormal 0 1]
    set preOpSegErrorZ [randNormal 0 1]
    set intraOpSegErrorX [randNormal 0 1]
    set intraOpSegErrorY [randNormal 0 1]
    set intraOpSegErrorZ [randNormal 0 1]
  } else {
